...
public class AuthenticatedJSONRequest {
...
//            SharedPreferences preferences = context.getSharedPreferences("My Preferences", Context.MODE_PRIVATE); //Initialing shared prefs
//            String tokenString = preferences.getString(SharePrefs.key_user_token, null); //getting saved token string from shared preferences, null - since it is easier to check condition later on
